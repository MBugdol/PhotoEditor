        ...
        Frame {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    IntegerInput {id: scaleWidthInput; minval: 1; maxval: 3840; startval: 1920; onEditingFinished: scale()}
                    Label {id: scaleHeightLabel; text: "Height"}
                    IntegerInput {id: scaleHeightInput; minval: 1; maxval: 3840; startval: 1080; onEditingFinished: scale()}
                }
                Button {
